...
if beautiful_input()[0].lower() == 'y':
    ...
    for again in range(1, 6):
        data = queryst(again)
        question = '{0:{1}{2}{3}}'.format(f'level {again}) ' + data[0], ' ', '^', 212)
        vars1 = '{0:{1}{2}{3}}'.format('1) ' + data[2][0], ' ', '^', 105) + '*' + '{0:{1}{2}{3}}'.format(
            '2) ' + data[2][1], ' ', '^', 105)
        vars2 = '{0:{1}{2}{3}}'.format('3) ' + data[2][2], ' ', '^', 105) + '*' + '{0:{1}{2}{3}}'.format(
            '4) ' + data[2][3], ' ', '^', 105)
        ...
        if again == 5:
            ...
            count_ = 1
            print("\n" * 60)
            with open(file='banner2.txt') as f:
                for line in f:
                    count_ += 1
                    print(line[:-2])
                    if count_ > 58:
